    ...
    model(0)
{
	...
	ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a HaraCoin address (e.g. CfwYhBmGXcFP2Po1NpRUEiK8km2)"));
    ...
    QAction *clipboaHARhangeAction = new QAction(tr("Copy change"), this);
    ...
    connect(clipboaHARhangeAction, SIGNAL(triggered()), this, SLOT(coinControlClipboaHARhange()));
    ...
    ui->labelCoinControlChange->addAction(clipboaHARhangeAction);
...
void SendCoinsDialog::coinControlClipboaHARhange()
{
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->style()->polish(ui->labelCoinControlChangeLabel);
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid HaraCoin address"));
        }
        else
        {
