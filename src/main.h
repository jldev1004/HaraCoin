...
static const int LAST_POW_BLOCK = 5256000; //about 10,000 Years of PoW blocks
...
static const uint256 hashGenesisBlock("0x0000094b4a28086ca94bd661437de18b68344e782b189b77529467ceb164c4ba");
static const uint256 hashGenesisBlockTestNet("0x0000094b4a28086ca94bd661437de18b68344e782b189b77529467ceb164c4ba");
...
public:
    ...
    {
        // HaraCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // HaraCoin: get transaction coin age
...
public:
    ...
    // HaraCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // HaraCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // HaraCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // HaraCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // HaraCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // HaraCoin: block index flags
    enum  
    {
